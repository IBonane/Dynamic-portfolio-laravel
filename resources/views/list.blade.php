                                ...
                                @foreach ($formations as $formation)
                                    <div class="row mt-2 card">
                                        <div class="col-md-12 card-body d-flex justify-content-between">
                                            ...
                                            <a class="btn btn-warning"
                                                href="{{ route('updateFormation.show', ['id' => $formation->id]) }}">Editer</a>
                                            <a class="btn btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#exampleModal{{ $formation->id }}">Supprimer</a>
                                        </div>
                                    </div>

                                    <!-- Modal -->
                                    <div class="modal fade" id="exampleModal{{ $formation->id }}" tabindex="-1"
                                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-footer">
                                                    <form
                                                        action="{{ route('deleteFormation.post', ['id' => $formation->id]) }}"
                                                        method="post">
                                                        @csrf
                                                        <button type="submit" class="btn btn-danger">OUI</button>
                                                    </form>
